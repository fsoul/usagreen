			...
			?>
				...
				<table class="csds_support">
					...
					<tr>
						...
						echo '</td>';
						echo '<td>';
						echo '<h2 class="support">'.__( 'Coming Soon 1.6.0.0 Verify New User Email, ', 'user-registration-aide' );
						echo '<br/>';
						echo __( ' New User Approval, ', 'user-registration-aide' );
						echo '<br/>';
						echo __( ' and Login Protection Features to be Added!', 'user-registration-aide' ).'</h2>';
